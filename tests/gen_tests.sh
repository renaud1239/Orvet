...
./gen_test.sh ../exemples/binaire.orv entrées/binaire.txt sorties/binaire.ref
...
./gen_test.sh ../exemples_avancés/RC4.orv entrées/RC4-2.txt sorties/RC4-2.ref

./gen_test.sh ../exemples_avancés/RC4.orv entrées/RC4-3.txt sorties/RC4-3.ref
